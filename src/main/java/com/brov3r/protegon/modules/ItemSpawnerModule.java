 ...
 * Item Spawner
 */
public class ItemSpawnerModule extends Module {
    /**
     * Constructs a new {@code Module} with the specified packet type, name, and description.
     */
    public ItemSpawnerModule() {
        super(PacketTypes.PacketType.InvMngGetItem, "itemSpawner", "Item Spawner", "Blocking items from being given to other players");
    }
